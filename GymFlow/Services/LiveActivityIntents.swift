...
// MARK: - Canal de comunicación
//
// Existe una copia idéntica en GymFlowWidget/LiveActivityIntents.swift.
// Con grupos sincronizados de Xcode cada carpeta pertenece a un solo target,
// así que el tipo se declara en ambos (mismo patrón que
// WorkoutActivityAttributes.swift).
//
// Este archivo NO depende de nada de la app a propósito: solo publica
// notificaciones. Los LiveActivityIntent SIEMPRE se ejecutan en el proceso de
// la app principal (no en el del widget), así que la notificación llega a
// ActiveWorkoutSession, que es quien está suscrito y hace el trabajo real.
